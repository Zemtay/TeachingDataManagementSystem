...
- **多维度数据可视化**  
  ...
  - 核心图表类型：教师授课量折线图、课程学生数柱状图、学生互动散点图、班级学生活动均衡性雷达图、学生任务平均完成情况柱状图；
  - 交互能力：所有图表支持前端缩放、按学期 / 班级 / 课程维度筛选、点击数据点查看详细信息（如学生姓名、具体数值、统计口径），无需切换页面即可完成深度数据探索。
...
| 安全机制     | BCrypt口令加密、RBAC 角色权限模型、数据行级过滤（教师仅访问本人授课数据）、SQL注入防护、Web目录安全检测、操作日志审计 |
